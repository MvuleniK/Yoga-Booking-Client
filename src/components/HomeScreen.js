...
//       <h1>Welcome to Yoga Booking App</h1>
//       <p className="lead">Book your next yoga class with us!</p>
//       <Link to="/classes" className="btn btn-primary btn-lg">View Classes</Link>
//     </div>
//   );
// }
